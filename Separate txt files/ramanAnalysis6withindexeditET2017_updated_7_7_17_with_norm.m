...
function [outputs] = ramanAnalysis6withindexeditET2017_updated_7_7_17_with_norm(pmma) 
...
for j=1:length(goodData(1, 1, :)) %*loops for number of .txt files*
    spectrum = goodData(:, :, j); %creates temporary variable spectrum which
...
%     Height1684 = amide1Spectrum(147);
    %height at 1690.36 
    Height1690 = amide1Spectrum(wn1690index);
%     %height at 1248.18
...
%    Pen2Am3=PenArea/amide3Area;
    ...
    outputs(j, :) = [MinMatAm3Area, MinMatprohypArea, XSTPhosFWHM, CarbPhosArea, XLR1660Height,XLRarea];  
